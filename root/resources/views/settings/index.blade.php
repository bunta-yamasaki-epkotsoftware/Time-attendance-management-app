...
@section('content')
    ...
    <div class="bg-white py-8 px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-lg p-4 border mb-4">
                <button id="installButton" class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-lg" style="display: none;">
                    アプリをインストール
                </button>
            </div>
            <div class="bg-white rounded-lg shadow-lg p-4 border">
